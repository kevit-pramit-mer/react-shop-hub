              ...
              <div className="px-4 py-2">
                ...
                <div className="flex flex-col space-y-2 ml-2">
                  <Link
                    ...
                    onClick={() => setIsMobileMenuOpen(false)}
                    className="py-2 text-gray-700 hover:text-blue-600 transition flex items-center"
                  >
              ...
              {isAuthenticated && (
                <div className="px-4 py-2 border-t border-gray-200 mt-2 pt-4">
                  ...
                  <Link
                    to="/profile"
                    onClick={() => setIsMobileMenuOpen(false)}
                    className="flex items-center py-2 text-gray-700 hover:text-blue-600 transition"
                  >
                    <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                    </svg>
                  ...
                  <button
                    ...
                    className="flex items-center w-full py-2 text-red-600 hover:text-red-700 transition mt-2 pt-3 border-t border-gray-200"
                  >
                    <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                    </svg>
